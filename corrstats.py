...
def dependent_corr(xy, xz, yz, n, twotailed=True, conf_level=0.95, method='steiger'):
    """
    Calculates the statistic significance between two dependent correlation coefficients. Is \rho_{XY} equal to \rho_{XZ}?
    H0: xy==xz 
    ...
    if method == 'steiger':
        ...
        raise Exception('Method must be "zou" or "steiger"!')
