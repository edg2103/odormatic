...
mediansPvals = pickleload(codepath+'moleculeAnalysis_results_overlap_plus_mean_2.0_FT0_expandSet_2018-07.dump')['mediansPvals']
...
mediansPvals = pickleload(codepath+'moleculeAnalysis_results_non_overlap2_plus_mean_2.0_FT0_expandSet_2018-07.dump')['mediansPvals']
markers=['s','<','o']; #markerfacecolors = ['white','black','lightgrey']
linestyles=['solid','solid','solid']#'dashed','-.']
fig, ax = plt.subplots()
for style,key,marker in zip(linestyles, ['Semantics2','Perceptual','Half2'], markers):
...
mediansPvals = pickleload(codepath+'moleculeAnalysis_results_overlap_plus_mean_2.0_FT0_expandSet_2018-07.dump')['sqmeans']
...
mediansPvals = pickleload(codepath+'moleculeAnalysis_results_non_overlap2_plus_mean_2.0_FT0_expandSet_2018-07.dump')['sqmeans']
markers=['s','<','o',None]; #markerfacecolors = ['white','black','lightgrey']
linestyles=['solid','solid','solid','dashed']#,'-.']
fig, ax = plt.subplots()
mediansPvals['Perceptual'][1.0]=[0]; mediansPvals['Baseline'][1.0]=[0]
